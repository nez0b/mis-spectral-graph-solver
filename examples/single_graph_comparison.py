...
def run_comprehensive_comparison(G):
    ...
    benchmark_config = {
        ...
        'dirac_config': {
            ...
            'mean_photon_number': 0.001,  # Example: Override default photon number
            'quantum_fluctuation_coefficient': 50,  # Example: Override default fluctuation
        ...
        'dirac_pgd_config': {
            ...
            'dirac_mean_photon_number': 0.002,  # Example: Override default photon number 
            'dirac_quantum_fluctuation_coefficient': 75,  # Example: Override default fluctuation
